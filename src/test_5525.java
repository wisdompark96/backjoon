...
public class test_5525 {
    public static void main(String[] args) throws IOException {
        ...
        stringBuilder.append("IOI");
        for(int i = 1; i < n; i++){
            stringBuilder.append("OI");
        }

        ArrayList<Integer> result = kmp(s, stringBuilder.toString());
    ...
    public static ArrayList<Integer> kmp(String str, String pattern) {
        ...
        char[] p = pattern.toCharArray();         // str - 전체 문자열, pattern - 찾을 문자열
        // j - 찾을 문자열의 비교 인덱스.
